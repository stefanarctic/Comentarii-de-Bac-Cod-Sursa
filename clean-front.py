...
def clean_page_numbers(json_file_path):
    """Curăță numerotarea de la începutul fiecărei pagini din fișierul JSON"""
    ...
    try:
        ...
        # Curăță numerotarea de la începutul fiecărei pagini
        cleaned_pages = []
        for page in pages:
            # Elimină numărul de la început (una sau mai multe cifre)
        ...
        print(f"✅ Numerotarea de la început a fost ștearsă din {json_file_path}!")
